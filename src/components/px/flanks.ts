...
export const FLANKS = {
  ...
  'home-humans': {
    ...
    actors: [
      ...
      { name: 'emirati-boy', x: 21, y: 63, h: 15, motion: 'cheer', marks: false, speed: '1.3s' },
      { name: 'girl-abaya', x: 24, y: 44, h: 15, motion: 'cheer', marks: false, speed: '1.6s', hop: '1.7s' },
      { name: 'girl-purple-hijab-up', x: 47, y: 27, h: 15, motion: 'cheer', marks: false, speed: '1.4s', hop: '2.1s' },
      { name: 'emirati-boy', x: 50, y: 77, h: 15, motion: 'cheer', marks: false, speed: '1.6s', hop: '1.8s' },
  ...
  'home-robots': {
    ...
    actors: [
      { name: 'robot-1', x: 57, y: 47, h: 13, motion: 'bob', speed: '2.5s' },
      { name: 'robot-cheering', x: 12, y: 11, h: 17, motion: 'cheer', marks: false, speed: '1.8s', hop: '2.2s' },
      { name: 'robot-chunky', x: 18, y: 77, h: 16, motion: 'bob', speed: '3.2s' },
      { name: 'robot-happy-cheering', x: 25, y: 26, h: 16, motion: 'cheer', marks: false, speed: '1.6s', hop: '2.0s' },
      { name: 'robot-1', x: 82, y: 52, h: 14, motion: 'bob', speed: '2.2s' },
      ...
      { name: 'robot-1', x: 67, y: 38, h: 14, motion: 'bob', speed: '2.9s' },
    ],
  },
