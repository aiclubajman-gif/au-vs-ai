...
export const FLANKS = {
  ...
  'home-humans': {
    ...
    actors: [
      ...
      { name: 'girl-purple-hijab-up', x: 50, y: 77, h: 15, motion: 'cheer', marks: false, speed: '1.4s', hop: '2.1s' },
      { name: 'emirati-boy', x: 47, y: 27, h: 15, motion: 'cheer', marks: false, speed: '1.6s', hop: '1.8s' },
