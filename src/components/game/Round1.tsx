...
// Not `Image`: that would shadow the browser constructor that preloads the next image.
...
export function Round1({
  ...
  return (
    <main className={styles.page}>
      ...
      <img src={ROUND1_PLATE_SRC} alt="" aria-hidden="true" className={styles.backdrop} />
      <div className={styles.stage}>
        <NextImage
          src={ROUND1_PLATE_SRC}
          alt=""
          aria-hidden="true"
          width={941}
          height={1672}
